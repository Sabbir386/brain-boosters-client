        ...
        <>
            ...
            <div className=' px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 '>
                ...
                <div className="flex justify-center w-full py-2 gap-2">
                    <a href="#item1" className="btn btn-success">1</a>
                    <a href="#item2" className="btn btn-success">2</a>
                    <a href="#item3" className="btn btn-success">3</a>
                    <a href="#item4" className="btn btn-success">4</a>
                </div>
            </div>
